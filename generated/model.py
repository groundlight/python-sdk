...
#   timestamp: 2026-02-05T01:25:08+00:00
...
class AccountMonthToDateInfo(BaseModel):
    ...
    iqs_limit: Optional[int] = Field(
        ...,
        description="The limit on the number of image queries in the current month.",
    )
...
class DetectorCreationInputRequest(BaseModel):
    ...
    pipeline_config: Optional[constr(max_length=100)] = Field(
        None,
        description="(Advanced usage) Configuration needed to instantiate a prediction pipeline.",
    )
