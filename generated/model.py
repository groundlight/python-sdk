...
#   timestamp: 2024-05-30T23:33:20+00:00
...
class DetectorCreationInputRequest(BaseModel):
    ...
    patience_time: Optional[confloat(ge=0.0, le=3600.0)] = Field(
...
class ImageQuery(BaseModel):
    metadata: Dict[str, Any] = Field(..., description="Metadata about the image query.")
    id: str = Field(..., description="A unique ID for this object.")
