...
#   timestamp: 2025-08-28T17:06:01+00:00
...
class AccountMonthToDateInfo(BaseModel):
    ...
    iqs_limit: int = Field(..., description="The limit on the number of image queries in the current month.")
    escalations_limit: int = Field(..., description="The limit on the number of escalations in the current month.")
    active_detectors_limit: int = Field(
