...
#   timestamp: 2024-08-05T17:49:43+00:00
...
class ROI(BaseModel):
    """
    A serializer for ROI objects.
    Corresponds directly with predictors.types.ROI

    The class should handle like a normal serializer, just note that the when instantiating as
    ROISerializer(instance=obj), the obj is the json representation pulled straight from the database
    """
