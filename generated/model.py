...
#   timestamp: 2024-10-09T22:17:52+00:00
...
class Source(str, Enum):
    """
    Source is optional to support edge v0.2
    """
...
class BinaryClassificationResult(BaseModel):
    ...
    source: Optional[Source] = Field(None, description="Source is optional to support edge v0.2")
    label: Label
