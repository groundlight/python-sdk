...
#   timestamp: 2024-03-05T00:35:09+00:00
...
class Action(BaseModel):
    channel: Optional[str] = Field(None, description="The channel to send the action to.")
...
class Condition(BaseModel):
    verb: Optional[str] = Field(None, description="The verb to use in the condition.")
...
class RuleBase(BaseModel):
    ...
    snooze_time_unit: Optional[str] = Field("DAYS", description="What unit of time to use for the snooze time.")
