...
#   timestamp: 2025-08-28T18:37:34+00:00
...
class AccountMonthToDateInfo(BaseModel):
    ...
    iqs_limit: Optional[int] = Field(None, description="The limit on the number of image queries in the current month.")
    escalations_limit: Optional[int] = Field(
        None, description="The limit on the number of escalations in the current month."
    )
    active_detectors_limit: Optional[int] = Field(
        None, description="The limit on the number of active detectors in the current month."
    )
