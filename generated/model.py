...
#   timestamp: 2023-05-26T19:56:12+00:00
...
class DetectorCreationInput(BaseModel):
    ...
    config_name: Optional[constr(max_length=100)] = Field(
        None,
        description=(
            "(Advanced usage) If your account has multiple named ML configuration options enabled, you can use this"
            " field to specify which one you would like to use."
        ),
    )
