...
#   timestamp: 2024-09-30T00:19:00+00:00
...
class CountModeConfigurationSerializer(BaseModel):
    id: str
    max_count: int


class MultiClassModeConfigurationSerializer(BaseModel):
    id: str
    num_classes: int
...
class ImageQuery(BaseModel):
    ...
    result: Union[BinaryClassificationResult, CountingResult]
