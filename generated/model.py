...
#   timestamp: 2024-07-30T22:21:00+00:00
...
class LabelValue(BaseModel):
    ...
    flag_archived: Optional[bool] = None
    annotations_requested: List[AnnotationsRequestedEnum]
    review_reason: Optional[Union[ReviewReasonEnum, BlankEnum, NullEnum]] = None
    created_at: datetime
...
class LabelValueRequest(BaseModel):
    ...
    posicheck_id: constr(min_length=1)
    value: Optional[float] = None
    feedback_text: Optional[str] = None
    rois: Optional[Any] = Field(None, description="List of region-of-interest (ROI) annotations")
    flag_archived: Optional[bool] = None
