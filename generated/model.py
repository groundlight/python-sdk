...
#   timestamp: 2024-05-06T06:11:43+00:00
...
class Note(BaseModel):
    ...
    created_at: datetime = Field(..., description="Timestamp indicating when the note was created.")
    updated_at: datetime = Field(..., description="Timestamp indicating the last time the note was updated.")
    created_by: int = Field(..., description="The owner of the note. Which is who created the note.")
...
class Detector(BaseModel):
    ...
    metadata: Dict[str, Any] = Field(..., description="Metadata about the detector.")
    mode: str
    mode_configuration: Dict[str, Any]
...
class DetectorCreationInputRequest(BaseModel):
    ...
    patience_time: Optional[confloat(ge=10.0)] = Field(
...
class ImageQuery(BaseModel):
    ...
    result: Dict[str, Any] = Field(..., description="The result of the image query.")
...
class Rule(BaseModel):
    ...
    snooze_time_enabled: Optional[bool] = False
    snooze_time_value: Optional[conint(ge=0)] = 0
    snooze_time_unit: Optional[SnoozeTimeUnitEnum] = "DAYS"
