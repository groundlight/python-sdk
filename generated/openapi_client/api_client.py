...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DetectorsApi()
        api_instance.create_detector  # this is an instance of the class Endpoint
        api_instance.create_detector()  # this invokes api_instance.create_detector.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_detector.callable or self.callable in this class
