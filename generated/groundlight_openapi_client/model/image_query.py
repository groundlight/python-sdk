...
class ImageQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'result_type': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metadata, id, type, created_at, query, detector_id, result_type, result, patience_time, confidence_threshold, rois, text, *args, **kwargs):  # noqa: E501
