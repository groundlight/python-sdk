...
class WebhookActionRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'payload_template': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'last_message_failed': (bool,),  # noqa: E501
            'last_failure_error': (str, none_type,),  # noqa: E501
            'last_failed_at': (datetime, none_type,),  # noqa: E501
        }
