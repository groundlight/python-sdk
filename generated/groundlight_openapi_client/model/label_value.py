...
class LabelValue(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'detector_id': (int, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, confidence, class_name, annotations_requested, created_at, detector_id, source, text, *args, **kwargs):  # noqa: E501
