...
class StaleFromStatusEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """StaleFromStatusEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): * `queued` - queued * `running` - running., must be one of ["queued", "running", ]  # noqa: E501

        Keyword Args:
            value (str): * `queued` - queued * `running` - running., must be one of ["queued", "running", ]  # noqa: E501
