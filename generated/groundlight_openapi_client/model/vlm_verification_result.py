...
def lazy_import():
    ...
    globals()["VerdictEnum"] = VerdictEnum


class VlmVerificationResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, verdict, confidence, reasoning, *args, **kwargs):  # noqa: E501
        """VlmVerificationResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, verdict, confidence, reasoning, *args, **kwargs):  # noqa: E501
        """VlmVerificationResult - a model defined in OpenAPI
