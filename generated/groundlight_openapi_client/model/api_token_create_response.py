...
class ApiTokenCreateResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'token_ttl': (int, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        'name': 'name',  # noqa: E501
        'raw_key_snippet': 'raw_key_snippet',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, raw_key_snippet, created_at, last_used_at, raw_key, *args, **kwargs):  # noqa: E501
        """ApiTokenCreateResponse - a model defined in OpenAPI
        ...
        Args:
            ...
            last_used_at (datetime, none_type): The most recent time this API token was used for authentication. Null until first use.
        ...
        Keyword Args:
            ...
            token_ttl (int, none_type): Identity token lifetime policy in whole seconds. Null means tokens minted under this identity never expire. Omitted only by older servers that do not yet expose this field.. [optional]  # noqa: E501
        """
