...
class EdgeModelInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'pipeline_config': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'oodd_pipeline_config': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'predictor_metadata': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
