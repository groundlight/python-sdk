...
class InlineResponse2001EvaluationResults(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'total_ground_truth_examples': (int, none_type,),  # noqa: E501
            'total_labeled_examples': (int, none_type,),  # noqa: E501
            'kfold_pooled__balanced_accuracy': (float, none_type,),  # noqa: E501
            'kfold_pooled__positive_accuracy': (float, none_type,),  # noqa: E501
            'kfold_pooled__negative_accuracy': (float, none_type,),  # noqa: E501
            'precision__mean': (float, none_type,),  # noqa: E501
            'recall__mean': (float, none_type,),  # noqa: E501
            'roc_auc__mean': (float, none_type,),  # noqa: E501
            'balanced_system_accuracies': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'positive_system_accuracies': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'negative_system_accuracies': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'mean_absolute_error__mean': (float, none_type,),  # noqa: E501
            'objdet_precision__mean': (float, none_type,),  # noqa: E501
            'objdet_recall__mean': (float, none_type,),  # noqa: E501
            'objdet_f1_score__mean': (float, none_type,),  # noqa: E501
            'class_accuracies': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'confusion_dict': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'num_examples_per_class': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
        }
