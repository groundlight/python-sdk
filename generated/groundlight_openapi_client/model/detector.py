...
class Detector(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mode': (str,),  # noqa: E501
            'mode_configuration': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, created_at, name, query, group_name, metadata, mode, mode_configuration, *args, **kwargs):  # noqa: E501
