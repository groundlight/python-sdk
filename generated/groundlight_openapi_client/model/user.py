...
class User(ModelNormal):
    ...
    attribute_map = {
        ...
        "is_labeler": "is_labeler",  # noqa: E501
        "userprofile": "userprofile",  # noqa: E501
        "accepted_tos": "accepted_tos",  # noqa: E501
    ...
    read_only_vars = {
        "id",  # noqa: E501
        "groups",  # noqa: E501
        "is_labeler",  # noqa: E501
        "userprofile",  # noqa: E501
        "accepted_tos",  # noqa: E501
    }
    ...
    def _from_openapi_data(
        cls, id, username, groups, is_labeler, userprofile, accepted_tos, *args, **kwargs
    ):  # noqa: E501
        ...
        Args:
            ...
            groups ([Group]):
            is_labeler (bool): Add \"is_labeler\" field outside the django User model, without having to go through the pain of migrating to a custom User model.  https://www.django-rest-framework.org/api-guide/fields/#serializermethodfield
            userprofile (bool, date, datetime, dict, float, int, list, str, none_type):
            accepted_tos (bool): A boolean representing whether or not the user has accepted our terms of service.
