...
class DetectorCreationInputRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'pipeline_config': (str, none_type,),  # noqa: E501
            'edge_pipeline_config': (str, none_type,),  # noqa: E501
            'metadata': (str,),  # noqa: E501
            'mode': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'mode_configuration': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'priming_group_id': (str, none_type,),  # noqa: E501
        }
