...
class CountModeConfiguration(BaseModel):
    ...
    max_count: Optional[Annotated[int, Field(le=50, strict=True, ge=1)]] = None
    class_name: StrictStr
    __properties: ClassVar[List[str]] = ["max_count", "class_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"max_count": obj.get("max_count"), "class_name": obj.get("class_name")})
        return _obj
