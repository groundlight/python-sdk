...
class RuleAction(BaseModel):
    ...
    oneof_schema_2_validator: Optional[List[Action]] = None
    actual_instance: Optional[Union[Action, List[Action]]] = None
    one_of_schemas: Set[str] = {"Action", "List[Action]"}
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = RuleAction.model_construct()
        error_messages = []
        match = 0
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Action, List[Action]]]:
