...
class TextModeConfiguration(BaseModel):
    ...
    value_max_length: Optional[Annotated[int, Field(le=250, strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["value_max_length"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"value_max_length": obj.get("value_max_length")})
        return _obj
