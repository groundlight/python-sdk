...
class GetDetectorEvaluation200ResponseEvaluationResults(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if kfold_pooled__balanced_accuracy (nullable) is None
        # and model_fields_set contains the field
        if self.kfold_pooled__balanced_accuracy is None and "kfold_pooled__balanced_accuracy" in self.model_fields_set:
            _dict["kfold_pooled__balanced_accuracy"] = None
