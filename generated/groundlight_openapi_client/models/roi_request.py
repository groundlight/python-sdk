...
class ROIRequest(BaseModel):
    ...
    label: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The label of the bounding box.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "geometry": BBoxGeometryRequest.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
        })
        return _obj
