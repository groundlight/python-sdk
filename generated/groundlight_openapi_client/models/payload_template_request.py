...
class PayloadTemplateRequest(BaseModel):
    ...
    headers: Optional[Dict[str, Annotated[str, Field(min_length=1, strict=True)]]] = None
    __properties: ClassVar[List[str]] = ["template", "headers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"template": obj.get("template"), "headers": obj.get("headers")})
        return _obj
