...
class ActionsApi:
    ...
    def list_rules(
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        predictor_id: Annotated[Optional[StrictStr], Field(description="Filter rules by predictor ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param page_size: Number of results to return per page.
        :type page_size: int
        :param predictor_id: Filter rules by predictor ID
        :type predictor_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _list_rules_serialize(
        ...
        if predictor_id is not None:
            ...
            _query_params.append(("predictor_id", predictor_id))
