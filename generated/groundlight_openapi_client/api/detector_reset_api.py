...
class DetectorResetApi:
    ...
    def reset_detector(
        ...
        _param = self._reset_detector_serialize(
    ...
    @validate_call
    def reset_detector_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def reset_detector_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _reset_detector_serialize(
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/v1/detector-reset/{id}",
