...
class MonthToDateAccountInfoApi:
    ...
    @validate_call
    def month_to_date_account_info(
        self,
    ...
    @validate_call
    def month_to_date_account_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountMonthToDateInfo]:
        """month_to_date_account_info
    ...
    @validate_call
    def month_to_date_account_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _month_to_date_account_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v1/month-to-date-account-info",
